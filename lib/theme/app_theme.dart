...
/// A class that contains all theme configurations for the automotive sensor monitoring application.
class AppTheme {
  AppTheme._();

  // Precision Monochrome Color Palette
  static const Color primaryLight = Color(
      0xFF1A1D23); // Deep charcoal for primary text and critical data display
  static const Color secondaryLight = Color(
      0xFF4A5568); // Medium gray for supporting information and inactive states
  static const Color accentLight = Color(
      0xFF3182CE); // Professional blue for interactive elements and active monitoring indicators
  static const Color successLight = Color(
      0xFF38A169); // Muted green for positive states and successful calibration feedback
  static const Color warningLight = Color(
      0xFFD69E2E); // Amber for moderate impact alerts and attention-requiring states
  static const Color errorLight = Color(
      0xFFE53E3E); // Controlled red for critical impacts and system errors
  static const Color backgroundLight =
      Color(0xFFF7FAFC); // Soft off-white for primary backgrounds
  static const Color surfaceLight = Color(
      0xFFEDF2F7); // Light gray for card backgrounds and section divisions
  static const Color borderLight = Color(
      0xFFE2E8F0); // Minimal border color used sparingly for data separation
  static const Color textSecondaryLight =
      Color(0xFF718096); // Subdued gray for timestamps and metadata

  // Dark theme colors (adapted for automotive dashboard illumination)
  static const Color primaryDark =
      Color(0xFFF7FAFC); // Light text for dark backgrounds
  static const Color secondaryDark =
      Color(0xFFE2E8F0); // Light gray for supporting information in dark mode
  static const Color accentDark =
      Color(0xFF63B3ED); // Lighter blue for dark mode accessibility
  static const Color successDark =
      Color(0xFF68D391); // Lighter green for dark mode visibility
  static const Color warningDark =
      Color(0xFFF6E05E); // Lighter amber for dark mode alerts
  static const Color errorDark =
      Color(0xFFFC8181); // Lighter red for dark mode errors
  static const Color backgroundDark =
      Color(0xFF1A1D23); // Deep charcoal background
  static const Color surfaceDark = Color(0xFF2D3748); // Dark surface for cards
  static const Color borderDark = Color(0xFF4A5568); // Dark border color
  static const Color textSecondaryDark =
      Color(0xFFA0AEC0); // Light gray for secondary text in dark mode
  ...
  static const Color onPrimaryDark = Color(0xFF1A1D23);
  static const Color onSecondaryDark = Color(0xFF1A1D23);
  static const Color onSurfaceDark = Color(0xFFF7FAFC);
  static const Color onBackgroundDark = Color(0xFFF7FAFC);
  static const Color onErrorDark = Color(0xFF1A1D23);
  ...
  /// Light theme optimized for automotive sensor monitoring
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for technical minimalism
    ...
    // Bottom navigation for fleet management interface
    ...
    // Button themes for professional interface
    ...
    // Input decoration for sensor data entry
    ...
    // Switch theme for monitoring toggles
    ...
    // Checkbox theme for data selection
    ...
    // Slider theme for calibration controls
    ...
    expansionTileTheme: ExpansionTileThemeData(
      ...
      collapsedTextColor: primaryLight,
    ...
    // List tile theme for data entries
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    final Color textPrimary = isLight ? primaryLight : primaryDark;
  ...
  /// Helper method to get monospace text style for sensor data display
  static TextStyle getMonospaceStyle({
    required bool isLight,
    double fontSize = 14,
    FontWeight fontWeight = FontWeight.w400,
  }) {
    final Color textColor = isLight ? primaryLight : primaryDark;
  ...
  /// Helper method to get status color based on severity
